...
const experiences: Experience[] = [
  {
    ...
    company: "TD",
    description: "my role as a swe intern involves building fullstack applications for portfolio managers with Javascript and Python.",
  ...
  },
  {
    ...
    description: "a super rewarding job involving hosting office hours to answer questions and teaching tutorials.",
    ...
    >
      <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 ${index % 2 === 0 ? "" : "lg:flex-row-reverse"}`}>
        ...
        <div className={`${index % 2 === 0 ? "lg:text-right" : "lg:order-2"}`}>
          ...
          >
            <span className="block" style={{ fontSize: "5rem", fontWeight: 300, lineHeight: 0.9, letterSpacing: "-0.03em" }}>
              {experience.year}
            </span>
          </motion.div>
        </div>
        ...
        <div className={`${index % 2 === 0 ? "" : "lg:order-1"}`}>
          ...
          >
            <div>
              <h3 className="mb-2" style={{ fontSize: "1.75rem", fontWeight: 300, letterSpacing: "-0.02em" }}>
                {experience.title}
              </h3>
              <p className="text-white/60" style={{ fontSize: "1.125rem", fontWeight: 300, letterSpacing: "-0.01em" }}>
                {experience.company}
              </p>
            </div>

            <p className="text-white/80" style={{ fontSize: "1rem", fontWeight: 300, lineHeight: 1.8, letterSpacing: "-0.01em" }}>
  ...
  return (
    <section className="min-h-screen bg-transparent px-6 py-32">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 style={{ fontSize: "clamp(3rem, 8vw, 6rem)", fontWeight: 300, lineHeight: 0.9, letterSpacing: "-0.03em" }}>
            experiences
          </h2>
        </motion.div>
        ...
        >
          <p className="text-white/40" style={{ fontSize: "0.875rem", fontWeight: 300, letterSpacing: "0.1em" }}>
            end of timeline
          </p>
        </motion.div>
      </div>
