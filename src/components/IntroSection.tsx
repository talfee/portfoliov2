  ...
  return (
    <section className="min-h-screen bg-transparent flex items-center justify-center px-6 py-32">
      <motion.div
        ...
        className="max-w-3xl"
      >
        <p className="text-white/90 mb-4 break-words" style={bodyStyle}>
          thanks for visiting my website!
        </p>
        <p className="text-white/90 mb-6 break-words" style={bodyStyle}>
          most of my work related info is on my{' '}
          <a
          ...
          , so here are some things about me that aren't:
        </p>
        <ul className="text-white/90 mb-6 list-disc pl-6 break-words" style={bodyStyle}>
          <li className="mb-2">
          ...
          <li className="mb-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="UBC BIOMOD Jamboree 2024 article"
              className="underline underline-offset-4 decoration-current text-white/80 hover:text-white transition-colors duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="published research paper"
              className="underline underline-offset-4 decoration-current text-white/80 hover:text-white transition-colors duration-300"
            >
              new research
            </a>
          ...
          <li className="mb-2">
            i love reading and discussing them with others (
            <a
              href="https://www.goodreads.com/user/show/74831519-talfee"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="my Goodreads profile"
              className="underline underline-offset-4 decoration-current text-white/80 hover:text-white transition-colors duration-300"
            >
              my goodreads
            </a>
        ...
        <p className="text-white/90 mb-6 break-words" style={bodyStyle}>
          i love meeting new people. if anything here resonated, i'd love to grab a coffee!
        </p>
        <p className="text-white/90 mb-6 break-words" style={bodyStyle}>
          →{' '}
          <a
