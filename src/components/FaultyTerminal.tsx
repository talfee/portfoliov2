  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      if (!pause) {
        ...
        (program.uniforms.iTime.value as any) = elapsed;
        frozenTimeRef.current = elapsed;
      } else {
        (program.uniforms.iTime.value as any) = frozenTimeRef.current;
      }
      ...
      if (pageLoadAnimation && loadAnimationStartRef.current > 0) {
        ...
        (program.uniforms.uPageLoadProgress.value as any) = progress;
      }
